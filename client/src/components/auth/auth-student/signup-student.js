          ...
          <div className="col-lg-6">
            <div className="contact-form-warp">
              ...
              <form onSubmit={(e) => onSubmitForm(e)} className="contact-form">
                <input name="firstname" value={user.firstname} onChange={handelInputChange} type="text" placeholder="Your Name"/>
                <input name="lastname" value={user.lastname} onChange={handelInputChange} type="text" placeholder="Your last name"/>
                ...
                <input name="repeatPassword" value={user.repeatPassword} onChange={handelInputChange} type="password" placeholder="Confirm password"/>
